...
### …タイトル画面がすこしダサいのはさておき、これからこのゲームを作るうえでこだわったポイントを解説しようと思う
<br />
...
### 本来、この式は２Dにおけるナナメ移動だが、このゲームでは主人公は座標移動をいっさい行わないためこの式を使って敵を移動させることが容易に可能なのである。
...
### このように、このゲームではプレイヤーの座標が固定されていることを活かして一部の処理を簡単にしている。
<br />

<a id="anchor4"></a>
## こだわりポイントその3:自作楽曲を用いたゲーム中のＢＧＭ変更
<br />
